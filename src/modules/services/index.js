...
const ServicesContainer = lazy(() => componentLoader(() => import("./containers/ServicesContainer")));
const InstanceDetailContainer = lazy(() => componentLoader(() => import("./containers/InstanceDetailContainer")));
